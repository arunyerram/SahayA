...
//       <div style={{ padding: "80px 20px",marginTop:"250px", minHeight: "calc(100vh - 200px)" }}>
      ...
      <div style={{ padding: "80px 20px", marginTop: "250px", minHeight: "calc(100vh - 200px)" }}>
        ...
        {selectedProfessional && (
          ...
          >
            ...
            {/* Updated to pass professional details to book-appointment route */}
            <button
              onClick={() => navigate("/book-appointment", { state: { professional: selectedProfessional } })}
              style={{
                marginTop: "15px",
                backgroundColor: "#FF5733",
                color: "white",
