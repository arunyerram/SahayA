...
const systemMessage = {
  "role": "system",
  "content": "Hello! I’m your assistant. Feel free to ask me anything!"
};
...
function Chatbot() {
  ...
  const [messages, setMessages] = useState([
    {
      message: `Hello! I am ${chatbotName || "your assistant"}. Ask me anything.`,
      sentTime: "just now",
  ...
  return (
    <>
      ...
      >
        ...
        <div style={{ marginTop: "200px", height: "400px", width: "600px", alignSelf: "center" }}>
          <MainContainer>
            <ChatContainer>
              <MessageList
                scrollBehavior="smooth"
