...
function Chatbot() {
  ...
  return (
    <>
      ...
      <button
  style={{
    marginTop: "190px", // Adjust to ensure it's below the navbar
    color: "blue",
    position: "relative", // Makes the button flow naturally in the document
    display: "block", // Ensures the button takes a full line
...
>
  <FaMicrophone /> Speak
      ...
      >
        ...
        <div style={{ marginTop: "250px", marginBottom:"50px",height: "300px", width: "600px", alignSelf: "center" }}>
          <MainContainer>
            <ChatContainer>
              <MessageList
                scrollBehavior="smooth"
