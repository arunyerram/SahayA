...
>
  ...
  <motion.div
    style={{
      fontSize: "4rem", // Increased font size for larger icons
      display: "flex",
      justifyContent: "center",
      alignItems: "center", // Ensures vertical alignment
      gap: "40px", // Adjust gap between icons
    }}
    initial={{ scale: 0.8 }}
    animate={{ scale: 1 }}
  ...
  >
    <img
      ...
      alt="Notepad"
      title="Notepad"
      style={{ width: "70px", height: "50px", cursor: "pointer" }} // Increased size
    ...
    <img
      ...
      alt="Scribble Pad"
      title="Scribble Pad"
      style={{ width: "70px", height: "70px", cursor: "pointer" }} // Increased size
