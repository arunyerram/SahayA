...
import React, { useState, useEffect } from "react";
import { FaSmile, FaRegSadCry, FaRobot, FaHandshake, FaHeart, FaStar, FaRocket, FaBolt } from "react-icons/fa";
import { motion } from "framer-motion";
import { Link, useNavigate } from "react-router-dom";
import { Canvas } from "@react-three/fiber";
import { OrbitControls } from "@react-three/drei";
...
const Home = () => {
  ...
  const characters = [
    {
      id: 1,
      name: "Character 1",
      emojis: [<FaSmile />, <FaHeart />, <FaStar />, <FaRocket />],
    },
    {
      id: 2,
      name: "Character 2",
      emojis: [<FaRegSadCry />, <FaBolt />, <FaRobot />, <FaHandshake />],
    },
  ];
  ...
  return (
    <div className="home-container">
      ...
      <h1 className="welcome-title">Welcome to the Support Platform!</h1>
          ...
          <div className="character-card" key={char.id}>
            ...
            <div className="character-with-emojis">
              <Canvas>
                ...
                <ambientLight intensity={0.5} />
                <directionalLight position={[10, 10, 5]} intensity={1} />
                <Character currentAnimationName="Idle" />
              </Canvas>

              <div className="emoji-container">
                {char.emojis.map((emoji, index) => (
                  <motion.div
      ...
      <div className="button-container">
        ...
        <button onClick={() => navigate("/consultancy")}>Consultancy</button>
