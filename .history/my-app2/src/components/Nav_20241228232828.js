...
//   const dropdownRef = useRef(null);
//   const [darkMode, setDarkMode] = useState(false);
//   const [storedChatbotName, setStoredChatbotName] = useState('');

//   // Fetch stored chatbot name when the component mounts
//   useEffect(() => {
//     const name = localStorage.getItem('chatbotName'); // Retrieve stored name
//     if (name) {
//       setStoredChatbotName(name);
//     } else if (chatbotName) {
//       localStorage.setItem('chatbotName', chatbotName); // Store name on first load
//       setStoredChatbotName(chatbotName);
//     }
//   }, [chatbotName]);
...
//   return (
//     <nav className="navbar navbar-expand-lg fixed-top" style={{ backgroundColor: "brown", zIndex: 1000 }}>
//       <div className="container-fluid">
//         <Link className="navbar-brand" to="/home" style={{ color: "white", marginRight: "380px" }}>
//           Sahaya
//         </Link>
...
//         <div className="navbar-nav">
//           <Link className="navbar-brand" to="/Chatbot" style={{ color: "white", marginRight: "340px" }}>
//             {storedChatbotName || "Chatbot"}  {/* Display the stored chatbot name */}
//           </Link>
//           <Link className="navbar-brand" to="/Consultancy" style={{ color: "white", marginRight: "180px" }}>
//             Consultancy
//           </Link>
...
//               src="data:image/png;base64,"
//               alt="Logo"
//               style={{ height: "30px", width: "30px" }}  // Logo size for button
//             />
//           </button>

//           {showDropdown && (
//             <div className="dropdown-menu" style={{ backgroundColor: "#6c757d" }}>
...
import React, { useState, useEffect, useRef } from "react";
import { Link } from "react-router-dom";
import { auth } from "./Firebase.js"; // Import auth from Firebase or wherever it is defined
      ...
      <div className="container-fluid">
        ...
        <div className="dropdown ms-auto" ref={dropdownRef}>
          ...
          >
            {/* Replace Profile text with logo */}
            <img
              src="data:image/png;base64,"
              alt="Logo"
