...
const Nav = ({ chatbotName }) => {
  const [showDropdown, setShowDropdown] = useState(false);
  const [isNavbarCollapsed, setIsNavbarCollapsed] = useState(true); // State to handle navbar collapse
  const dropdownRef = useRef(null);
    ...
    <nav className="navbar navbar-expand-lg fixed-top" style={{ backgroundColor: "brown", zIndex: 1000 }}>
      <div className="container-fluid">
        ...
        <button
          className="navbar-toggler"
          type="button"
          onClick={toggleNavbar} // Trigger toggle on button click
        ...
        <div className={`collapse navbar-collapse ${isNavbarCollapsed ? "collapse" : "show"}`} id="navbarNav">
          ...
          <div className="dropdown ms-auto" ref={dropdownRef}>
            ...
            >
              {/* Replace Profile text with logo */}
              <img
                src="data:image/png;base64,"
                alt="Profile"
