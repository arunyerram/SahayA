...
const Home = () => {
  const navigate = useNavigate();
  const [chatbotName, setChatbotName] = useState(""); // Chatbot name state
    ...
    <>
      ...
      <div className="banner">
        <div className="slider" style={{ "--quantity": 4 }}>
          <a href="/page1" className="item" style={{ "--position": 1 }}>
            <div className="card">Card 1</div>
          </a>
          <a href="/page2" className="item" style={{ "--position": 2 }}>
            <div className="card">Card 2</div>
          </a>
          <a href="/page3" className="item" style={{ "--position": 3 }}>
            <div className="card">Card 3</div>
          </a>
          <a href="/page4" className="item" style={{ "--position": 4 }}>
