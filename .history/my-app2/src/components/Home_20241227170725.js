...
<div className="card-container">
  ...
  >
    <div className="slider" style={{ "--quantity": 4 }}>
      <a href="/chatbot" className="item" style={{ "--position": 1 }}>
        <div className="card">
          <img src="/images/Chatbot.jpg" alt="Chatbot" className="card-image" />
      ...
      <a href="/personal-assistant" className="item" style={{ "--position": 2 }}>
        <div className="card">
          <img src="images/personlassistant.jpg" alt="Personal Assistant" className="card-image" height="40px" width="8px" />
          <div className="card-content">
      ...
      <a href="/consultancy" className="item" style={{ "--position": 3 }}>
        <div className="card">
          <img src="images/consultancy.jpg" alt="Personal Guidance" className="card-image" />
          <div className="card-content">
      ...
      <a href="/tasksDone" className="item" style={{ "--position": 4 }}>
        <div className="card">
          <img src="images/Todo.webp" alt="Todo Tracker" className="card-image" height= "60px" />
          <div className="card-content">
            <h3>Todo-Tracker</h3>
  ...
  >
    <img
      src="/path-to-your-image-folder/notepad.png"
      alt="Notepad"
      title="Notepad"
    ...
    />
    <img
      src="/path-to-your-image-folder/scribblepad.png"
      alt="Scribble Pad"
      title="Scribble Pad"
      style={{ width: "60px", height: "60px", cursor: "pointer" }}
