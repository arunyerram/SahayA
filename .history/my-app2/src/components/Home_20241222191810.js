    ...
    <>
      ...
      <div
        style={{
          ...
          alignItems: "center",
          margin: "160px 0 60px 0", // Added extra space from the navbar
        }}
      >
        <Canvas style={{ height: "1000px", width: "800px",marginBottom:"100px" }}>
      ...
      {/* Emoji Section */}
      <div style={{ textAlign: "center", margin: "05px 0" }}>
        <h2>Express Your Feelings</h2>
        <motion.div
          style={{
            fontSize: "2rem",
