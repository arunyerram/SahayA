    ...
    <>
      ...
      <div className="consultancy-container">
        ...
        <div className="profiles-grid mt-10 mb-10">
          ...
          <div className="card">
            <img
              src="/images/notification.jpg" // Ensure image path is correct
          ...
          <Link to="/tasksDone" className="card">
            <img
              src="/images/tasks.jpg" // Ensure image path is correct
              className="card-img-top"
              alt="To-Do List"
            />
            <div className="card-body">
          ...
          {/* Card 3: Completed Tasks (New Feature) */}
          <div className="card">
            <img
              src="/images/completed.jpg" // Ensure image path is correct
              className="card-img-top"
              alt="Completed Tasks"
            />
            <div className="card-body">
              <h5 className="card-title">Completed Tasks</h5>
              <p className="card-text">View tasks that are already completed.</p>
              <Link to="/tasksDone" className="btn btn-success">
