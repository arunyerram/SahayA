...
const Home = () => {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <motion.h1
        style={{ textAlign: "center", marginTop: "1000px 0", paddingTop: "20px" }}
        initial={{ opacity: 0, y: -50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 1 }}
      >
      ...
      >
        <div className="slider" style={{ "--quantity": 4 }}>
          ...
          <a href="page2.html" className="item" style={{ "--position": 2 }}>
            <div className="card">Professional Assistance</div>
          </a>
          <a href="page3.html" className="item" style={{ "--position": 3 }}>
            <div className="card">Professional Guidance</div>
          </a>
      ...
      >
        <Canvas style={{ height: "500px", width: "500px", marginBottom: "10px" }}>
          <OrbitControls enableZoom={false} />
          <ambientLight intensity={0.5} />
          <directionalLight position={[10, 10, 5]} intensity={1} />
          <Character currentAnimationName={currentAnimation} />
