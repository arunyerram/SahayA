    ...
    <div className="main">
      ...
      <div className="content">
        <div className="text">
          ...
          <h4 style={{fontSize: 30}}>THE AI THAT UNDERSTANDS YOU!</h4>

          </h3>
          
        
          <button onClick={() => navigate("/register")} style={{text-color:marginTop: "30px", fontFamily: 'poppins' }}>Willing to Share?</button>
        </div>
      </div>
