...
const Home = () => {
  ...
  return (
    <>
      ...
      <div style={{ textAlign: "center", margin: "-30px" }}>
        {/* <h2 >Express Your Feelings</h2> */}
        <h2 style={{ marginBottom: "20px" }}>Express Your Feelings</h2>
        <motion.div
          style={{
            fontSize: "2rem",
            display: "flex",
  ...
  transition={{ duration: 0.5 }}
>
  <button style={{ marginBottom: "10px" }} onClick={() => navigate("/chatbot")}>Chatbot</button>
  <button style={{ marginBottom: "10px" }} onClick={() => navigate("/consultancy")}>Assistance</button>
