...
const Home = () => {
  ...
  const handleClick = (animation) => {
    // Navigate to the Chatbot route or trigger the animation change
    navigate("/Chatbot");
  };
  ...
  return (
    <>
      ...
      >
        ...
        >
          <FaSmile style={{ fontSize: "50px", color: "gold" }} />
          <h3>Happy</h3>
        </div>
        ...
        >
          <FaRegSadCry style={{ fontSize: "50px", color: "blue" }} />
          <h3>Sad</h3>
        </div>
        ...
        >
          <FaRobot style={{ fontSize: "50px", color: "gray" }} />
          <h3>Need Help</h3>
        </div>
        ...
        <div
          ...
          onClick={() => handleClick("Professional Help")}
        >
          <FaHandshake style={{ fontSize: "50px", color: "green" }} />
