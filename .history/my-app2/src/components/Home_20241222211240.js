  ...
  return (
    <>
      ...
      <div style={{ textAlign: "center", margin: "02px 0" }}>
        ...
        >
          <FaSmile
            style={{ color: "gold", cursor: "pointer" ,fontSize: "48px"}}
            title="Happy"
            // onClick={() => setCurrentAnimation("Happy")}
            onClick={handleClick}
          />
          <FaRegSadCry
            style={{ color: "blue", cursor: "pointer",fontSize: "48px" }}
            title="Sad"
            // onClick={() => setCurrentAnimation("Sad")}
            onClick={handleClick}
          />
          <FaRobot
            style={{ color: "gray", cursor: "pointer",fontSize: "48px" }}
            title="Need Help"
            // onClick={() => setCurrentAnimation("Help")}
            onClick={handleClick}
          />
          <FaHandshake
            style={{ color: "green", cursor: "pointer",fontSize: "48px" }}
            title="Professional Help"
            // onClick={() => setCurrentAnimation("Handshake")}
            onClick={handleClick}
          />
