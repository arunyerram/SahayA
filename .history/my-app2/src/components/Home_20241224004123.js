...
import React, { useState, useEffect } from "react";
import { FaSmile, FaRegSadCry, FaRobot, FaHandshake, FaAngry, FaExclamationTriangle, FaGrinHearts } from "react-icons/fa";
import { motion } from "framer-motion";
import { Link, useNavigate } from "react-router-dom";
import { Canvas } from "@react-three/fiber";
import { OrbitControls } from "@react-three/drei";
    ...
    <>
      ...
      <div className="character-container">
        <Canvas style={{ height: "600px", width: "600px" }}>
          ...
          <ambientLight intensity={0.5} />
          <directionalLight position={[10, 10, 5]} intensity={1} />
          <Character scale={2} /> {/* Increased the size of the character */}
        </Canvas>
        ...
        <div className="emotion-cloud">
          ...
          <div className="emotion" onClick={() => handleEmotionClick("Angry")}>
            <FaAngry style={{ color: "red", fontSize: "50px" }} title="Angry" />
          </div>
          ...
          <div className="emotion" onClick={() => handleEmotionClick("Love")}>
            <FaGrinHearts style={{ color: "pink", fontSize: "50px" }} title="Love" />
          </div>
          <div className="emotion" onClick={() => handleEmotionClick("Help")}>
            <FaRobot style={{ color: "gray", fontSize: "50px" }} title="Need Help" />
          </div>
          <div className="emotion" onClick={() => handleEmotionClick("Professional")}>
            <FaHandshake style={{ color: "green", fontSize: "50px" }} title="Professional Help" />
          </div>
        </div>
      </div>
