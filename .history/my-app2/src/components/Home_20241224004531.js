...
//   const handleNameChange = (e) => setChatbotName(e.target.value);
...
//     alert(`Selected emotion: ${emotion}`);
//   };
...
//             />
//             <button onClick={handleNameSubmit} className="modal-submit">
//               Submit
//             </button>
//           </div>
//         </div>
...
//           <div className="emotion" onClick={() => handleEmotionClick("Happy")}>
//             <FaSmile style={{ color: "gold", fontSize: "40px" }} title="Happy" />
//           </div>
//           <div className="emotion" onClick={() => handleEmotionClick("Sad")}>
//             <FaRegSadCry style={{ color: "blue", fontSize: "40px" }} title="Sad" />
//           </div>
//           <div className="emotion" onClick={() => handleEmotionClick("Help")}>
//             <FaRobot style={{ color: "gray", fontSize: "40px" }} title="Need Help" />
//           </div>
//           <div className="emotion" onClick={() => handleEmotionClick("Handshake")}>
//             <FaHandshake style={{ color: "green", fontSize: "40px" }} title="Professional Help" />
//           </div>
//         </div>
//       </div>
...
import React, { useState, useEffect } from "react";
import { FaSmile, FaRegSadCry, FaAngry, FaMeh, FaSadTear, FaExclamationTriangle, FaBrain, FaRobot, FaHandshake } from "react-icons/fa";
import { motion } from "framer-motion";
import { Link, useNavigate } from "react-router-dom";
import { Canvas } from "@react-three/fiber";
import { OrbitControls } from "@react-three/drei";
  ...
  return (
    <>
      ...
      <div className="character-container">
        ...
        {/* Emotion cloud with circular positioning */}
        <div className="emotion-cloud">
          <div className="emotion" onClick={() => handleEmotionClick("Happy")}>
            <FaSmile style={{ color: "gold", fontSize: "50px" }} title="Happy" />
          </div>
          <div className="emotion" onClick={() => handleEmotionClick("Sad")}>
            <FaRegSadCry style={{ color: "blue", fontSize: "50px" }} title="Sad" />
          </div>
          <div className="emotion" onClick={() => handleEmotionClick("Crying")}>
            <FaSadTear style={{ color: "blue", fontSize: "50px" }} title="Crying" />
          </div>
          <div className="emotion" onClick={() => handleEmotionClick("Anger")}>
            <FaAngry style={{ color: "red", fontSize: "50px" }} title="Anger" />
          </div>
          <div className="emotion" onClick={() => handleEmotionClick("Bored")}>
            <FaMeh style={{ color: "gray", fontSize: "50px" }} title="Bored" />
          </div>
          <div className="emotion" onClick={() => handleEmotionClick("Anxiety")}>
            <FaBrain style={{ color: "purple", fontSize: "50px" }} title="Anxiety" />
          </div>
          <div className="emotion" onClick={() => handleEmotionClick("Tension")}>
            <FaExclamationTriangle style={{ color: "orange", fontSize: "50px" }} title="Tension" />
          </div>
          <div className="emotion" onClick={() => handleEmotionClick("Fear")}>
            <FaRobot style={{ color: "gray", fontSize: "50px" }} title="Fear" />
          </div>
        </div>
      </div>
