...
//       {/* Emoji Section - Emojis revolving in a circle */}
//       <div style={{ textAlign: "center", margin: "02px 0" }}>
//         <h2>Express Your Feelings</h2>
//         <motion.div
//           style={{
...
//           </motion.div>
//           {/* More emojis placed around the character */}
//           <motion.div
//             style={{
//               position: "absolute",
//               top: "100%",
...
const Home = () => {
  ...
  return (
    <>
      ...
      {/* Emoji Section - Emojis revolving around the character */}
      <div style={{ textAlign: "center", margin: "02px 0", position: "relative" }}>
        <h2>Express Your Feelings</h2>

        {/* The container holding the rotating emojis */}
        <motion.div
          style={{
            fontSize: "2rem",
            display: "flex",
            ...
            top: "50%",
            left: "50%",
            transform: "translate(-50%, -50%)", // Center the emojis container
            width: "300px",
            height: "300px",
          }}
          animate={{
            rotate: 360, // Emojis will rotate
          }}
          transition={{
            repeat: Infinity,
        ...
        >
          {/* Emojis placed around the character */}
          <motion.div
            style={{
              position: "absolute",
              top: "0",
