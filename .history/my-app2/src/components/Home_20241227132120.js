    ...
    <>
      ...
      >
        <div className="slider" style={{ "--quantity": 4 }}>
          ...
          <a href="/personal-assistant" className="slider" style={{ "--position": 2 }}>
            <div className="card">Personal Assistance</div>
          </a>
          <a href="/consultancy" className="slider" style={{ "--position": 3 }}>
            <div className="card">Personal Guidance</div>
          </a>
          <a href="/tasksDone" className="slider" style={{ "--position": 4 }}>
            <div className="card">Todo-Tracker</div>
          </a>
        </div>
        <div className="content">
          <h1 data-content="SAHAYA" style={{color:"Black"}}>SAHAYA</h1>
      ...
      >
        <Canvas style={{ height: "700px", width: "500px",marginTop:"40px", marginBottom: "4px" }}>
          <OrbitControls enableZoom={false} />
          <ambientLight intensity={0.5} />
          <directionalLight position={[10, 10, 5]} intensity={1} />
          <Character currentAnimationName={currentAnimation} />
      ...
      <div style={{ textAlign: "center", margin: "-30px" }}>
        <h2 style={{ marginBottom: "20px" ,color:"Black"}}>Express Your Feelings</h2>
        <motion.div
          style={{
