    ...
    <nav className={`navbar navbar-expand-lg fixed-top ${darkMode ? 'navbar-dark bg-dark' : 'navbar-light bg-light'}`} style={{ zIndex: 1000 }}>
      <div className="container-fluid">
        ...
        <div className="navbar-nav">
          ...
          <Link className="navbar-brand" to="/Consultancy" style={{ color: darkMode ? 'white' : 'black', marginRight: "10px" }}>
            Consultancy
          </Link>

          {/* Dark Mode Toggle Button exactly in between Consultancy and Profile */}
          <button
            ...
            style={{
              ...
              marginRight: "10px"  // Space around the button
            }}
          >
            {darkMode ? <FaSun /> : <FaMoon />}  {/* Sun icon for light mode, Moon icon for dark mode */}
          </button>
