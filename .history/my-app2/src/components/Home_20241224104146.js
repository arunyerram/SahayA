...
// import React,/**
//  * The `Home` component in this React application manages the main interface, including
//  * a chatbot name input modal, character animation, emoji selection, call-to-action
//  * buttons, feedback link, and logout button.
//  * @returns The `Home` component is being returned. It consists of JSX elements that
//  * make up the user interface of the home page of a support platform. The component
//  * includes a navigation bar (`Nav` component), a modal for entering the chatbot's
//  * name, an animated title, a character section with a 3D character, an emoji section
//  * for expressing feelings, call-to-action buttons for navigating to different sections
//  */
...
// import { FaSmile, FaRegSadCry, FaRobot, FaHandshake, FaLaugh, FaAngry, FaSurprise, FaHeart } from "react-icons/fa";
// import { motion } from "framer-motion";
// import { Link, useNavigate } from "react-router-dom";
// import { Canvas } from "@react-three/fiber";
// import { OrbitControls } from "@react-three/drei";
...
//             />
//             <button className="modal-button" onClick={handleNameSubmit}>
//               Submit
//             </button>
//           </div>
//         </div>
...
//       <motion.h1 className="animated-title">Welcome to Our Support Platform! 💡</motion.h1>
...
//           <FaSmile className="emoji happy" />
//           <FaRegSadCry className="emoji sad" />
//           <FaRobot className="emoji robot" />
//           <FaHandshake className="emoji handshake" />
//           <FaLaugh className="emoji laugh" />
//           <FaAngry className="emoji angry" />
//           <FaSurprise className="emoji surprise" />
//           <FaHeart className="emoji heart" />
//         </div>
//       </div>
    ...
    <div className="home-container">
      ...
      <div className="main-content">
        ...
        <div className="button-group">
          <button className="action-button">Chatbot</button>
          <button className="action-button">Assistance</button>
