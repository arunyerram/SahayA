    ...
    <>
      ...
      <div className="consultancy-container">
        ...
        <div className="profiles-grid mt-10 mb-10">
          ...
          <div className="card">
            <img
              src="/images/notification-send.jpg" // Continuous and meaningful image for notifications
          ...
          <Link to="/tasksDone" className="card">
            <img
              src="/images/todolist-track.jpg" // Continuous and meaningful image for tasks
              className="card-img-top"
